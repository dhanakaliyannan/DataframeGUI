...
class FilterListMenuWidget(QtWidgets.QWidgetAction):
    ...
    def on_list_itemChanged(self, item):
        ...
        ###
        print("Populate List Changed start")
...
if __name__ == '__main__':
    ...
    df = pandas.read_csv('/Users/advik/Downloads/12345.csv')
    app = DataFrameApp(df)
    app.show()
    _app.exec_()